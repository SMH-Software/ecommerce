...
$requete="SELECT * FROM articles WHERE categories='ordinateur bureau' ";
  ...
  <?php } ?>
    ...
    <div class="admin-content clearfix">
      <div class="button-group">
        <a href="create.php" class="btn btn-sm">Ajouter nouvel article</a>
       
      </div>
      <div class="">
        <h2 style="text-align: center;">Gestion Ordinateur de Bureau</h2>
        <table>
          <thead>
            <th>Image</th>
            <th>Désignation</th>
          ...
          <?php while($article=$resultat->fetch()) { ?>
            <tr class="rec">
              ...
              <td>
                <a href="edit_bureau.php?idarticle=<?= $article['id'] ?>" class="edit">
