...
$requete="SELECT * FROM articles WHERE categories='ordinateur portable' ";
  ...
  <?php } ?>
    ...
    <div class="admin-content clearfix">
      <div class="button-group">
        <a href="create_pc.php" class="btn btn-sm">Ajouter nouvel article</a>
       
      </div>
      <div class="">
        <h2 style="text-align: center;">Gestion Ordinateur Portable</h2>
        <table>
          <thead>
            <th>Image</th>
            <th>Désignation</th>
          ...
          <?php while($article=$resultat->fetch()) { ?>
            <tr class="rec">
              ...
              <td>
                <a href="edit_pc.php?idarticle=<?= $article['id'] ?>" class="edit">
