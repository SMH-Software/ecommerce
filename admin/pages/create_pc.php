  ...
  <?php } ?>
    ...
    <div class="admin-content clearfix">
      ...
      <div class="">
        ...
        <form action="../scripts/create_pc.php" method="post" enctype="multipart/form-data">
          ...
          <div class="input-group">
            <input type="text" name="categorie" class="text-input" value="ordinateur portable" hidden>
          </div>
