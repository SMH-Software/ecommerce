  ...
  <?php } ?>
    ...
    <div class="admin-content clearfix">
      ...
      <div class="">
        ...
        <form action="../scripts/create_pa.php" method="post" enctype="multipart/form-data">
          ...
          <div class="input-group">
            <input type="text" name="categorie" class="text-input" value="Périphérique et Accessoires" hidden>
          </div>
